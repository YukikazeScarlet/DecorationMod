...
public class OPS39Renderer extends TileEntitySpecialRenderer<TileOPS39> {
    ObjModelStruct struct;
    @Override
    public void render(TileOPS39 te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
