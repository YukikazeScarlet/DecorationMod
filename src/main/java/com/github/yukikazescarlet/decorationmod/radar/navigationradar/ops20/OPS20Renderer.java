...
public class OPS20Renderer extends TileEntitySpecialRenderer<TileOPS20> {
    ObjModelStruct struct;
    @Override
    public void render(TileOPS20 te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
